...
public class Problem2_dynamic_2D {
    ...
    public static Map TSP(int[][] adjacency, int n) {
            ...
            for(signal1 = 0; signal1 < bound1; signal1++) {
                ...
                for(i = 1; i < n; i++) {
                    ...
                    for(j = 0; j < n; j++) {
                        ...
                        int temp = adjacency[i][j] + D[j][convertSet(Aminusj(A, j, n), n)];
                        if(temp < 9999){
                            System.out.print("");
                        }
                        if(temp < minimum) {
        ...
        int minj = -1;
        for(j = 1; j < n; j++) {
            int temp = adjacency[0][j] + D[j][convertSet(Aminusj(V, j, n), n)];
            if(temp < minimum) {
                minimum = temp;
                minj = j;
            }
    ...
    public static void main(String args[]) {
        System.out.println("Dynamic algorithm uses two-dimensional matrix");
